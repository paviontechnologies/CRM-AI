  ...
  return (
    <div className="max-w-3xl space-y-6">
      <div>
        ...
        <p className="text-slate-500 text-sm mt-1">Manage your profile, organization and integrations</p>
      </div>
        ...
        <form onSubmit={saveOrg} className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div className="px-4 py-2.5 border border-slate-200 rounded-xl text-sm bg-slate-50 text-slate-600 capitalize">
      ...
      <Section title="Integrations" icon={Plug}>
        <div className="grid grid-cols-2 gap-4">
          {integrations.map(int => (
            <div key={int.name} className="flex items-center justify-between p-4 border border-slate-100 rounded-xl hover:border-slate-200 transition-colors">
              <div className="flex items-center gap-3">
                <span className="text-2xl">{int.icon}</span>
                <div>
                  <div className="font-semibold text-sm text-slate-900">{int.name}</div>
        ...
        <p className="text-xs text-slate-400 mt-4">Integrations require API keys. Configure them in your .env file or contact support.</p>
      </Section>
    </div>
  );
}
