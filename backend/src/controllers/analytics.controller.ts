...
export const getLeadsByIndustry = async (req: AuthRequest, res: Response) => {
  try {
    const orgId = req.user!.orgId;
...
export const getLeadsByStatus = async (req: AuthRequest, res: Response) => {
  try {
    const orgId = req.user!.orgId;
...
export const getWeeklyLeads = async (req: AuthRequest, res: Response) => {
  try {
    const orgId = req.user!.orgId;
    const days = 7;
